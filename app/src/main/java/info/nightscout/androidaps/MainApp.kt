...
class MainApp : DaggerApplication() {
    ...
    private fun checkMac() {
        ...
        /*
        if (!mac.equals("fc:bf:16:8b:90:32") && !mac.equals("a4:4b:d5:08:45:07") && !mac.equals("64:4e:8d:37:4f:0a") &&
            !mac.equals("10:5a:a5:83:a7:35") && !mac.equals("8c:7a:3d:24:16:c0")) {
            Log.i("VERIFY", "Verify device failed")
            //ToastUtils.showToastInUiThread(this, "设备认证失败，请从正规途径获取！")
            //onTerminate()
            exitProcess(0)
        }
        (
    ...
    private fun checkBrand() {
        ...
        if (brand.lowercase(Locale.getDefault()) != "xiaomi") {
            exitProcess(0)
        }
    }
